...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.027; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -3.46; // in; offset of the lateral wheel
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "drivebl"));
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "drivefr"));
    ...
    public List<Double> getWheelPositions() {
        return Arrays.asList(
                ...
                encoderTicksToInches(rightEncoder.getCurrentPosition() * X_MULTIPLIER * secret_sauce),
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                ...
                encoderTicksToInches(rightEncoder.getCorrectedVelocity() * X_MULTIPLIER * secret_sauce),
