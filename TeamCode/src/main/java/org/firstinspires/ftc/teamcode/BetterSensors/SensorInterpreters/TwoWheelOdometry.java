...
import org.firstinspires.ftc.teamcode.BetterSensors.Sensors.MotorEncoder;
import org.firstinspires.ftc.teamcode.BetterSensors.UpdatingSensorInterpreter;
...
public class TwoWheelOdometry extends UpdatingSensorInterpreter {
    ...
    public TwoWheelOdometry(MotorEncoder leftEncoder, MotorEncoder rightEncoder, Gyro gyro) {
        ...
        odometry = new DifferentialDriveOdometry(new Rotation2d(0), new Pose2d(0, 0, new Rotation2d()));
    }
